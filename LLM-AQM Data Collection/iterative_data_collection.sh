...
client_iperf3_script() {
    ...
    ssh -p "$src1port" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -c 172.16.1.2 -P 2 -t $duration -p 5101 -J -C cubic > iperf3_client_cubic_${iter}_$aqm.json" &
    ssh -p "$src1port" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -c 172.16.1.2 -P 2 -t $duration -p 5102 -J > iperf3_client_${tcp1}_${iter}_$aqm.json" &
