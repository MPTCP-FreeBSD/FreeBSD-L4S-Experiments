...
configure_routers() {
    ...
    d=$3
    e=$4
    echo "-*-*-*-*_*_*_*_*_*_*__*_*_*_*_*__*_*_*_*_*_*__*_*_*_*_*__*_*__*_*"
...
start_log(){
    ...
    if [ "$do_tcpdump" -eq 1 ]; then
        ...
        ssh -p "$srchostport" -i "$sshkeypath" root@"$vmhostaddr" \
        "tcpdump -i em1 -w /root/${testname}.em1.pcap > /root/tcpdump.em1.out 2>&1 & tcpdump -i em2 -w /root/${testname}.em2.pcap > /root/tcpdump.em2.out 2>&1 &"
...
client_iperf3_script() {
    ...
    sleep 10    
    ssh -p "$srchostport" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -c 172.16.3.2 -t 60 -p 5104" >/dev/null &
...
server_iperf3_script() {
    ...
    ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -s -p 5101 --rcv-timeout 120" >/dev/null &
    sleep 10    
    ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -s -p 5102 --rcv-timeout 120" >/dev/null &
    sleep 10    
    ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -s -p 5103 --rcv-timeout 120" >/dev/null &
    sleep 10    
    ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "iperf3 -s -p 5104 --rcv-timeout 120" >/dev/null &
