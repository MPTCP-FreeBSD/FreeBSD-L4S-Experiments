...
# ssh -p $srchostport -i ~/.ssh/$sshkey root@$vmhostaddr "iperf3 -s -p 5102 -1" >/dev/null &




ssh -p $dsthostport -i ~/.ssh/$sshkey root@$vmhostaddr "iperf3 -c 172.16.3.2 -t 60 -p 5102" >/dev/null &
sleep 10
...
# sleep 10
# ssh -p $srchostport -i ~/.ssh/$sshkey root@$vmhostaddr "iperf3 -c 172.16.3.2 -t 60 -p 5104" >/dev/null &
